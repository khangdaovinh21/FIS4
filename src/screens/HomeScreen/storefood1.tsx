...
import { View, Text, Image, StyleSheet, ScrollView, TouchableOpacity, TextInput, FlatList, Modal, StatusBar } from 'react-native';
                ...
                {showInputGroup ? (
                    ...
                    <View style={styles.groupContent}>
                        <View style={styles.groupIconText}>
                            ...
                            <Text style={styles.text}>Hadilao HotPot</Text>
